...
```{r}
# mean(stim1_df$C + stim1_df$D)
# mean((stim1_df$nC - stim1_df$C) + (stim1_df$nD - stim1_df$D))
# 
# mean(stim1_df$A + stim1_df$B + stim1_df$C + stim1_df$D)
# mean((stim1_df$nA - stim1_df$A) + (stim1_df$nB - stim1_df$B) + (stim1_df$nC - stim1_df$C) + (stim1_df$nD - stim1_df$D))
